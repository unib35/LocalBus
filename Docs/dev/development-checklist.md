...
| Bundle Identifier 설정     | ✅   | kr.co.lee.LocalBusApp         |
...
| 항목                       | 상태 | 비고                          |
| -------------------------- | ---- | ----------------------------- |
| 앱 이름 및 부제            | ✅   | LocalBus - 장유-사상 버스 시간표 |
...
| 항목                       | 상태 | 비고                          |
| -------------------------- | ---- | ----------------------------- |
| 오프라인 모드 테스트       | ✅   | Unit Test로 검증 완료         |
| 네트워크 전환 테스트       | ✅   | Unit Test로 검증 완료         |
| 다양한 시간대 테스트       | ✅   | QualityVerificationTests      |
| 공휴일 로직 테스트         | ✅   | Unit Test로 검증 완료         |
| 메모리 누수 검사           | ✅   | Address Sanitizer + 코드 분석 |
...
| 0.3.0 | 2026-01-29 | App Store 배포 준비, 메타데이터/개인정보방침 작성 |
